# ==================================================
# IRIS ZSH THEME
# Fork visual de "jonathan"
# Lógica intacta — solo cambios estéticos
# ==================================================

# --------------------------------------------------
# Hooks y opciones (IGUAL que jonathan)
# --------------------------------------------------
...
# --------------------------------------------------
# Colores (MISMA base, ligeros cambios Iris)
# --------------------------------------------------
...
# --------------------------------------------------
# Charset / líneas (IGUAL que jonathan)
# --------------------------------------------------
...
# --------------------------------------------------
# PROMPT (estructura idéntica, solo texto/brackets)
# --------------------------------------------------
PROMPT='${PR_SET_CHARSET}${PR_STITLE}${(e)PR_TITLEBAR}\
${PR_CYAN}${PR_ULCORNER}${PR_HBAR}${PR_GREY}(\
${PR_GREEN}<%${PR_PWDLEN}<...<%~%<<>\
${PR_GREY})$(virtualenv_prompt_info)$(ruby_prompt_info)$(conda_prompt_info)\
${PR_CYAN}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}${PR_HBAR}${PR_GREY}(\
${PR_MAGENTA}<%(!.%SROOT%s.%n)@%m>%\
${PR_GREY})${PR_CYAN}${PR_HBAR}${PR_URCORNER}\

${PR_CYAN}${PR_LLCORNER}${PR_BLUE}${PR_HBAR}(\
${PR_YELLOW}<%D{%H:%M:%S}>\
${PR_MAGENTA}$(git_prompt_info)$(git_prompt_status)\
${PR_BLUE})${PR_CYAN}${PR_HBAR}${PR_HBAR}>${PR_NO_COLOUR} '
